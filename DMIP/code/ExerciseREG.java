...
public class ExerciseREG {
	...
	public RigidParameters registerPoints(SimpleMatrix p, SimpleMatrix q){
		...
		double abs_r = r1*r1+r2*r2;//TODO
		r1/=abs_r;//TODO: normalize r
		r2/=abs_r;//TODO: normalize r
	...
	public SimpleMatrix buildMeasurementMatrix(SimpleMatrix q) {
		...
		for(int i = 0; i < numPoints; i++) {
			...
			//real part of the problem (even rows)
				m.setElementValue(i*2, 0, q.getElement(i, 0));//TODO
				m.setElementValue(i*2, 1, -q.getElement(i, 1));//TODO
				m.setElementValue(i*2, 2, 1);//TODO
				m.setElementValue(i*2, 3, 0);//TODO
			//imaginary part of the problem (odd rows)
				m.setElementValue(i*2+1, 0, q.getElement(i, 1));//TODO
				m.setElementValue(i*2+1, 1, q.getElement(i, 0));//TODO
				m.setElementValue(i*2+1, 2, 0);//TODO
				m.setElementValue(i*2+1, 3, 1);//TODO
		}
	...
	public SimpleVector buildRHSVector(SimpleMatrix p) {
		...
		for(int i = 0; i < numPoints; i++) {
			...
			b.setElementValue(i*2, p.getElement(i, 0));//TODO: real part of the problem
			b.setElementValue(i*2+1, p.getElement(i, 1));//TODO: imaginary part of the problem
		}
	...
	public SimpleMatrix applyTransform(SimpleMatrix points, RigidParameters parameter){
		...
		for(int i = 0; i < transformedPoints.getRows(); i++){
			...
			transformedPoints.setRowValue(i, SimpleOperators.add(SimpleOperators.multiply(r, points.getRow(i)),parameter.translation));//TODO: rotate (you can use SimpleOperators)
