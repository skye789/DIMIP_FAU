...
public class Intro {
     ...
     */
    String outputDataLoc = "D:\\CONRAD\\CONRAD\\src\\edu\\stanford\\rsl\\tutorial" + "\\mipda\\";
	...
	public void basicIntro() {
		...
		v1 =  new SimpleVector(3.0,2.0,1.0); //TODO
		if (v1 != null)
		...
		Mcopy.transpose();
		//get size
		numRows = M.getRows();//TODO
		numCols = M.getCols();//TODO
		...
		ResMat = SimpleOperators.multiplyMatrixProd(Mtrans, M);//TODO
		if (ResMat != null)
		...
		// -> SimpleOperators
		resVec =  SimpleOperators.multiply(M, v1);//TODO
		if (resVec != null)
		...
		subVector =  new SimpleVector(M.getElement(0, 2),M.getElement(1, 2)) ;//TODO
		if (subVector != null)
		...
		vecNormL2 = colVector.normL2(); //TODO L2 vector norm of colVector
	...
	public void signalIntro()
	{
		...
		{
			y[i] = Math.sin((double) i * stepSize * 2 * Math.PI);; //TODO
	...
	public void gridIntro(){
		...
		mrImage =  ImageUtil.wrapImagePlus(IJ.openImage(filename)).getSubGrid(0);//TODO
		if (mrImage != null)
		...
		if (mrImage != null) {
			...
			Grid2D outImage = ImageUtil.wrapFloatProcessor(ip);
			ImagePlus imp = new ImagePlus("mr12out.tiff",ImageUtil.wrapGrid2D(outImage).createImage());
			IJ.saveAsTiff(imp, outFileName);
			IJ.open(outFileName);
		}			
	}
